...
tools = [
  db_client.load_tool("get-outstanding-balance"),
  db_client.load_tool("get-loan-details"),
  db_client.load_tool("get-next-payment-date"),
  db_client.load_tool("list-loans"),
  db_client.load_tool("get-total-outstanding-balance"),
]
